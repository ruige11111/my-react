(function (global, factory) {
	...
	function pushEffect(hookFlags, create, destroy, deps) {
	    ...
	    const updateOueue = fiber.updateQueue;
	    if (updateOueue === null) {
	...
	function createFCUpdateQueue() {
	    const updateOueue = createUpdateQueue();
	...
	function dispatchSetState(fiber, updateOueue, action) {
	    const lane = requestUpdateLane();
	    const update = createUpdate(action, lane);
	    enqueueUpdate(updateOueue, update);
